...
export default function FeedbackSuccessStep({onFeedbackRestartRequested}: FeedbackSuccesStepProps) {
    ...
    return(
        ...
        <button
        className="py-2 px-6  mt-6 bg-zinc-800 rounded-md border-transparenttext-sm leading-6 hover:bg-zinc-700 transition-colors focus-outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offfset-zinc-900 focus:ring-brand-500 disabled:opacity-50 disabled:hover:bg-brand-500"
